...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glm::vec3 directionalLightColor(1.0f, 0.8f, 0.1f);
        ...
        // Arrays are set the same way as other uniforms in GLSL. Some
        // string formating is required set lights without hardcoding. 
